...
public class Rating {
    private final double DEFAULT_RATING = 1500;
    private final double DEFAULT_DEVIATION = 350;
    private final double DEFAULT_VOLATILITY = 0.06;
    ...
    private final double VOLATILITY_CHANGE = 0.5;
    private final double GLICKO_NUMBER = 173.7178;
    private final double CONVERGENCE_NUMBER = 0.000001;
